  ...
  <div>
    <section class="content">
      <el-form label-width="150px" label-position="left">
        ...
        <!--<h4>设备状态 <span style="font-size: 15px;color: #888;margin-left: 10px">设备ID：{{deviceId}}</span></h4>-->
        <!--</el-col>-->
        <!--</el-row>-->
        ...
        <div class="center-block add-appdiv" style="margin-left: 20px">
          <el-row>
            ...
            <el-col :span="8" :offset="2">
              <!--<el-form-item label="主板温度" style="text-align: left">-->
              <!--<span v-bind:class="temperatureStyle">{{deviceStatus.boardTemp != null ? deviceStatus.boardTemp : '&#45;&#45;'}}°C</span>-->
              <!--</el-form-item>-->
              <!--<el-form-item label="抓取记录" style="text-align: left" v-show="deviceForm !== 'CON_OUTDOOR_POLE'"><span-->
              <!--v-bind:class="temperatureStyle">{{deviceStatus.catchRecord != null ? deviceStatus.catchRecord : '&#45;&#45;'}}条</span>-->
              <!--</el-form-item>-->
