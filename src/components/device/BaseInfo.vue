  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        tunneldialogWidth: $.Device.isPC() ? '35%' : '90%',
        labelWidth: $.Device.isPC() ? '120px' : '110px',
...
//        console.log(pos);
      ...
      updateSys() {
        this.$confirm('确认进行设备升级？', '提示', {
          ...
          this.$post('set/upgrade/' + this.deviceMonitor.deviceId + '/' + this.deviceMonitor.deviceForm, {},
            "升级命令下发成功");
        }).catch(() => {
        });
      },
    ...
    mounted() {
      ...
      this.getRemote();
      this.getBaseInfo();
//      if (this.$route.query.deviceForm === 'CON_OUTDOOR_POLE') {//大站====版本详细信息
//        this.getVersions();
//      } else {//小站
//        this.getBaseInfo();
//      }
