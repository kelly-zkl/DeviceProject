<template>
  <div>
    <section class="content">
      ...
      <div class="content" style="margin-left: 10px" v-show="activeItem == 'collision'">
        <el-row>
          <el-col :span="18">
      ...
      <div class="content" style="margin-left: 10px" v-show="activeItem == 'follow'">
        <el-row>
          <el-col :span="18">
    ...
    methods: {
      ...
      getCaseDetail() {
        this.$post('/case/get/' + this.caseId, {}).then((data) => {
          ...
          this.caseDetail.timeStr = $.Data.formatDate(new Date(this.caseDetail.creatTime * 1000), 'yyyy-MM-dd hh:mm:ss');
          this.caseDetail.fishStr = this.caseDetail.updateTime !== 0 ? $.Data.formatDate(new Date(this.caseDetail.updateTime * 1000), 'yyyy-MM-dd hh:mm:ss') : '--';
          this.caseDetail.startStr = $.Data.formatDate(new Date(this.caseDetail.caseTime * 1000), 'yyyy-MM-dd hh:mm:ss');
          this.caseDetail.endStr = $.Data.formatDate(new Date(this.caseDetail.caseToTime * 1000), 'yyyy-MM-dd hh:mm:ss');
        }).catch((err) => {
        });
      }
    },
